...
enum AntialiasedElement
{
  ...
  ,
  aePlottables =
    0x0020  ///< <tt>0x0020</tt> Main lines of plottables (excluding error bars,
            ///< see element \ref aeErrorBars)
  ,
...
/*!
Defines plotting hints that control various aspects of the quality and speed of
plotting.
...
enum PlottingHint
{
  ...
  ,
  phFastPolylines =
    0x001  ///< <tt>0x001</tt> Graph/Curve lines are drawn with a faster method.
...
validity upon replots, when the compiler flag \c QCUSTOMPLOT_CHECK_DATA is set.
*/
...
public:
  ...
  */
  enum PainterMode
  {
    ...
    ,
    pmNoCaching =
      0x02  ///< <tt>0x02</tt> Mode for all sorts of exports (e.g. PNG,
...
protected:
  ...
  // non-virtual methods:
  void addChildX(
    QCPItemPosition* pos);  // called from pos when this anchor is set as parent
